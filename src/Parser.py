...
class parser:
    ...
    def parser(self,mapa):
        ...
        for line in lines:             # Percorrer todas as linhas do file
            tamanhoLinha=len(line)-1   # Como a matriz, começa na coluna 0 e linha 0 tira-se uma unidade (Exemplo: 6 colunas - Vai da coluna 0 até á coluna 5)
            for i in range(tamanhoLinha): # Percorrer a linha toda, caractere a caractere
